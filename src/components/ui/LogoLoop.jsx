...
const renderLogoItem = useCallback(
  (item, key) => {
    ...
    // Asignamos el nodo a una variable con Mayúscula (Icon) 
    // para que React pueda renderizarlo como <Icon />
    const Icon = isNodeItem ? item.node : null;

    const content = isNodeItem ? (
      <span
        className={cx(
          'inline-flex items-center text-white', // Forzamos blanco por el fondo negro
      ...
      >
        {/* Verificamos si es una función (componente) o un elemento JSX */}
        {typeof Icon === 'function' ? <Icon size={logoHeight} /> : Icon}
      </span>
    ) : (
      <img
        className={cx(
...
const DefaultLogoLoop = LogoLoop;
export default DefaultLogoLoop;